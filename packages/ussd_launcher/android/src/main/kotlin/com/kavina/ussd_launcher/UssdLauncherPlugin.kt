...
class UssdLauncherPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        when (call.method) {
            ...
            "launchUssdCall" -> handleLaunchUssdCall(call, result)
    ...
    private fun handleLaunchUssdCall(call: MethodCall, result: Result) {
        val ussdCode = call.argument<String>("ussdCode")
        val slotIndex = call.argument<Int>("slotIndex") ?: 0
        ...
        ussdMultiSession.launchUssdCall(ussdCode, slotIndex, result)
    }

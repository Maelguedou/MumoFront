    ...
    private fun sendUssdRequestModern(ussdCode: String, subscriptionId: Int, result: MethodChannel.Result) {
        ...
        val callback = object : TelephonyManager.UssdResponseCallback() {
            override fun onReceiveUssdResponse(telephonyManager: TelephonyManager, request: String, response: CharSequence) {
                replySuccess(response.toString())
            }
            ...
            override fun onReceiveUssdResponseFailed(telephonyManager: TelephonyManager, request: String, failureCode: Int) {
                ...
                replyError("USSD_FAILED", errorMessage)
            }
        }
        ...
        scope.launch {
            try {
                ...
                replyError("PERMISSION_DENIED", "Permission denied: ${e.message}")
            } catch (e: Exception) {
                replyError("UNEXPECTED_ERROR", "Unexpected error: ${e.message}")
            }
        }
    }
